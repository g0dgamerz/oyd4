...
class Game {
	...
	constructor() {
		...
		this.canvas.style.backgroundColor = "purple"
		...
		let testLevel = function() {
			...
			new MovingPlat(this, [800, 500, 50, 10], 1, -1, 90, 2)
			new MovingPlat(this, [800, 350, 50, 10], -1, -1, 90, 2)

			new MovingPlat(this, [300, 250, 50, 10], 1, 0, 200, 2)
			new MovingPlat(this, [200, 200, 50, 10], 0, 1, 100, 2)
			new MovingPlat(this, [200, 100, 50, 10], 0, 1, 150, 2)
			new MovingPlat(this, [250, 50, 50, 10], 1, 0, 150, 2)
			new MovingPlat(this, [550, 100, 50, 10], -1, 0, 170, 2)
			new MovingPlat(this, [650, 100, 50, 10], -1, 0, 170, 2)
			new MovingPlat(this, [750, 100, 50, 10], 1, 1, 170, 2)

			new MovingPlat(this, [470, 500, 100, 60], 1, 0, 100, 2)
			new GameObject(this, [80, 530, 300, 30], "green", false)
			...
			new GameObject(this, [960, 20, 50, 50], "Red", false)
